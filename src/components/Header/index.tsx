...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-sm sticky top-0 z-50 border-b border-editorial-mist">
      ...
      {isMenuOpen && (
        <div id="mobile-menu" className="md:hidden fixed top-16 right-0 bottom-0 left-0 bg-editorial-mist bg-opacity-95 backdrop-blur-md z-[60] px-6 py-8 shadow-2xl border-t border-editorial-mist">
