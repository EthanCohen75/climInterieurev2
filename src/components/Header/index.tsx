...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-sm sticky top-0 z-50 border-b border-editorial-mist">
      ...
      {isMenuOpen && (
        <div id="mobile-menu" className="md:hidden fixed inset-0 top-16 bg-editorial-mist bg-opacity-95 backdrop-blur-md z-[60] px-6 py-8 shadow-2xl border-t border-editorial-mist">
